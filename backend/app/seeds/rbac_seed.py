...
ROLE_PERMISSIONS: dict[str, list[str]] = {
    "admin": [
        P.ELEMENT_VIEW, P.ELEMENT_CREATE, P.ELEMENT_DELETE, P.ELEMENT_MAP,
        P.ROLE_READ_ALL, P.SEND_INVITE,
        P.GROUP_READ, P.GROUP_WRITE, P.GROUP_DELETE,
        P.CARETAKER_READ, P.CARETAKER_ASSIGN,
        P.BACKUP_CREATE,
        P.USER_READ, P.USER_WRITE, P.USER_DELETE,
        P.ONBOARDING_READ, P.ONBOARDING_SUBMIT, P.ONBOARDING_EDIT,
    ],
    "researcher": [
        P.FORM_VIEW, P.FORM_CREATE, P.FORM_GET, P.FORM_UPDATE,
        P.FORM_DELETE, P.FORM_PUBLISH, P.FORM_UNPUBLISH,
        P.GOAL_TEMPLATE_VIEW, P.GOAL_TEMPLATE_CREATE, P.GOAL_TEMPLATE_EDIT,
    ],
    "participant": [
        P.GOAL_VIEW_ALL, P.GOAL_ADD, P.GOAL_EDIT, P.GOAL_DELETE,
